...
const App = () => {
  const [menuItems, setMenuItems] = useState([
    { id: 1, name: 'Full Paneer Roll', nameHi: 'पनीर रोल', description: 'Delicious paneer roll', descriptionHi: 'स्वादिष्ट पनीर रोल', category: 'maincourse', quantity: 0, image: paneerRollImage },
